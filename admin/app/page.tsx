  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', maxWidth: 960, margin: '0 auto', padding: 24 }}>
      ...
      <section style={{ marginTop: 32 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                {pendingChanges.map((change) => {
                  ...
                  return (
                    <tr key={change.id} style={{ borderBottom: '1px solid #eee' }}>
                      <td>
                      ...
                      <td style={{ display: 'flex', gap: 8 }}>
                        <button type="submit" formAction={approveChange.bind(null, change.id)}>
                          Approve
                        </button>
                        <button type="submit" formAction={rejectChange.bind(null, change.id)}>
                          Reject
                        </button>
                      </td>
                    </tr>
        ...
        {pendingChanges.length === 0 && <p>Nothing waiting on review.</p>}
      </section>
